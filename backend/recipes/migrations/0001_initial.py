# Generated by Django 3.2.3 on 2024-01-26 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True, validators=[django.core.validators.RegexValidator(message='Ссылка должна содержать только буквы, цифры, дефис или подчеркивание.', regex='^[-a-zA-Z0-9_]+$')], verbose_name='Ссылка')),
            ],
            options={
                'verbose_name': 'Тэг',
